...
local V = Instance.new("Frame", Crosshair)
V.Size = UDim2.fromOffset(2,20)
V.Position = UDim2.fromScale(0.5,0.5)
V.AnchorPoint = Vector2.new(0.5,0.5)
V.BackgroundColor3 = Color3.new(1,1,1)

local H = Instance.new("Frame", Crosshair)
H.Size = UDim2.fromOffset(20,2)
H.Position = UDim2.fromScale(0.5,0.5)
H.AnchorPoint = Vector2.new(0.5,0.5)
H.BackgroundColor3 = Color3.new(1,1,1)

-- Curseur actif au départ
...
-- ESP dynamique : joueur rejoint / personnage spawn
...
-- Tous les joueurs déjà présents
